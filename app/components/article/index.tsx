...
export default function Articles({
  ...
  return (
    <section className='relative z-[1] flex flex-col items-center  text-white bg-black my-20 sm:px-4 md:px-8 xl:px-16 max-w-[1440px] mx-auto'>
      ...
      <div className='grid xl:grid-cols-[40%_1fr] md:grid-cols-2 grid-cols-1 gap-x-5 gap-y-20 md:gap-10 lg:gap-20 xl:mx-20 lg:mx-10 md:mx-0 sm:mx-10 mx-5 my-10 md:mb-20'>
