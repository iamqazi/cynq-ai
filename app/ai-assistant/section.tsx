...
export default function TradingFeatures() {
  return (
    <section className="bg-black text-white py-16 relative overflow-hidden">
      {/* Central 3D Model */}
      <div className="absolute top-[400px] left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] lg:w-[400px] lg:h-[400px] z-10">
        <Image
      ...
      {/* Main Heading */}
      <h2 className="text-[48px]  leading-[56px] text-center font-bold max-w-6xl mx-auto px-5 mb-24 relative z-20">
