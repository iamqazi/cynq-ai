...
import { ArrowUpRight, CircleHelp, WalletMinimal } from 'lucide-react'
...
export default function Staking() {
  ...
  return (
    <main className='bg-black'>
      <Navbar />
      <section className='max-w-[1020px]  mx-auto flex flex-col my-[46px] min-h-screen xs:px-4 px-2'>
        <div className='bg-[#1e1e1e] w-full  rounded-t-xl flex items-center  justify-between px-2 xs:px-6 sm:px-[40px] sm:py-[31px] py-5 text-[#FFFFFF] font-semibold flex-wrap gap-y-3 '>
          <p className='lg:text-xl xl:text-[22px]  md:text-lg text-base '>
            Lock LCAI to earn more LCAI
          </p>
          <div className='flex items-center gap-2 '>
            <a
              href=''
              className='underline hover:no-underline md:text-base text-sm  text-[#FFFFFF]/70 '
            >
              Get LCAI
            </a>
            <span className='border border-white/15 text-white/70 rounded-[50%] inline-block p-0.5'>
              <ArrowUpRight />
            </span>
          </div>
        </div>
        <div className='md:mx-[40px] xs:mx-[20px] mx-[10px] my-[30px]'>
            ...
            <article className='bg-[#61616129] border border-white/15 rounded-lg lg:px-[44px] px-[34px] lg:py-[30px] py-[20px] '>
              <ul className='xs:text-base text-sm  text-white/50  flex flex-col gap-[10px]'>
                <li className='flex justify-between text-[#CCCEEF]'>
                  <span className='underline'>LCAI to be locked</span>
          ...
          <div className='flex flex-col gap-[15px] items-center mb-[30px]'>
            <Button className='uppercase rounded-lg bg-[#7B15F8] xs:text-base text-sm xs:px-[28px] px-[18px] xs:py-[12px] py-[8px] shadow-[0px_0px_80px_#7b15f8ac]'>
