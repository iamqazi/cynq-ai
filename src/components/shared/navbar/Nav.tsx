...
export default function Nav({ sideBarOpen, setSideBarOpen }: propType) {
  ...
  const links = [
    ...
    {
      text: t("nav_predictive_ai"),
      link: `/${locale}/predictive-ai`,
    },
    {
      text: t("nav_ai_trading"),
      link: `/${locale}/ai-assistant`,
    },
    {
      text: t("nav_ai_arbitrage"),
      link: `/${locale}/ai-arbitrage`,
    },
    {
      text: t("nav_ai_tax_tool"),
      link: `/${locale}/ai-tax-tool`,
    },
    {
      text: t("nav_staking"),
      link: `/${locale}/staking`,
